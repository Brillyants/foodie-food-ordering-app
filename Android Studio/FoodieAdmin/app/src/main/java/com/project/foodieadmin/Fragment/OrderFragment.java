...
import com.project.foodieadmin.Adapter.OrderAdapter;
...
public class OrderFragment extends Fragment {
    ...
    public void GetAllOrder() {
        if(checkNetworkConnection()) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, DBContract.SERVER_GET_ALL_PAYMENT_URL,
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                adapter = new OrderAdapter(getContext(), allPaymentList);
