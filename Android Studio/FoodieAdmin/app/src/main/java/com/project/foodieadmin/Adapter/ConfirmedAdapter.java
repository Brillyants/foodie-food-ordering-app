...
import com.project.foodieadmin.Fragment.ConfirmedDetailFragment;
...
public class ConfirmedAdapter extends RecyclerView.Adapter<ConfirmedAdapter.ViewHolder> {
    ...
    public ConfirmedAdapter(Context context, ArrayList<PaymentDomain> orderDomains) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment confirmedDetailFragment = new ConfirmedDetailFragment();
                ...
                confirmedDetailFragment.setArguments(bundle);

                FragmentManager fragmentManager = ((AppCompatActivity)context).getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.main_container, confirmedDetailFragment);
